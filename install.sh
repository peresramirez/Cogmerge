...
#   --claude        install only the Claude Code tree (.claude/)
#   --cursor        install only the Cursor tree (.cursor/)
...
SKILLROOT=".claude"; [ "$WANT" = "cursor" ] && SKILLROOT=".cursor"
